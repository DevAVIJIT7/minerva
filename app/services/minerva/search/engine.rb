...
module Minerva
  module Search
    class Engine
      ...
      def initialize(params, resource_owner_id = nil, auth_scope = nil, permissions = nil)
      ...
      def perform
        ...
        global_filter = Minerva.configuration.filter_sql_proc.call(resource_owner_id, auth_scope, permissions, params) if Minerva.configuration.filter_sql_proc
